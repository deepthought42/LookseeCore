...
import com.crawlerApi.browsing.form.ElementRuleExtractor;
import com.crawlerApi.gcp.CloudVisionUtils;
import com.crawlerApi.gcp.GoogleCloudStorage;
import com.crawlerApi.gcp.ImageSafeSearchAnnotation;
...
import com.crawlerApi.models.ImageFaceAnnotation;
import com.crawlerApi.models.ImageLandmarkInfo;
import com.crawlerApi.models.ImageSearchAnnotation;
...
import com.crawlerApi.models.Template;
import com.crawlerApi.models.enums.BrowserEnvironment;
import com.crawlerApi.models.enums.BrowserType;
import com.crawlerApi.models.enums.ElementClassification;
import com.crawlerApi.models.enums.TemplateType;
...
public class BrowserService {
	...
	public Page buildPage( String page_src, 
		...
		List<com.crawlerApi.models.Element> elements = extractElements(clean_source, clean_url, rule_sets);
	 ...
	 * @pre rendered_css_values != null
	 */
	public static com.crawlerApi.models.Element buildElement(
			String xpath, 
			Map<String, String> attributes, 
		...
		com.crawlerApi.models.Element element = new com.crawlerApi.models.Element(jsoup_element.ownText(), xpath, jsoup_element.tagName(), attributes, pre_rendered_css_values, jsoup_element.html(), classification, jsoup_element.outerHtml());
	...
	public Set<Form> extractAllForms(long account_id, Domain domain, Browser browser) throws Exception {
		...
		for(WebElement form_elem : form_elements){
			...
			com.crawlerApi.models.Element form_tag = new com.crawlerApi.models.Element(
					form_elem.getText(), 
			...
			Form form = new Form(form_tag, 
								 new ArrayList<com.crawlerApi.models.Element>(), 
	...
	private List<com.crawlerApi.models.Element> buildFormFields(long account_id, List<WebElement> input_elements, Browser browser) throws IOException {
		List<com.crawlerApi.models.Element> elements = new ArrayList<>();
		for(WebElement input_elem : input_elements){
			...
			com.crawlerApi.models.Element input_tag = new com.crawlerApi.models.Element(input_elem.getText(),
			...
			com.crawlerApi.models.Element tag_record = element_service.findByKeyAndUserId(account_id, input_tag.getKey());
			if( tag_record != null ) {
	 ...
	 */
	@Deprecated
	private com.crawlerApi.models.Element findFormSubmitButton(WebElement form_elem, 
															Browser browser
	) throws Exception {
		...
		com.crawlerApi.models.Element elem = new com.crawlerApi.models.Element(submit_element.getText(), 
	...
	public Map<String, Template> findTemplates(List<com.crawlerApi.models.Element> element_list){
		//create a map for the various duplicate elements
		Map<String, Template> element_templates = new HashMap<>();
		List<com.crawlerApi.models.Element> parents_only_element_list = new ArrayList<>();
		for(com.crawlerApi.models.Element element : element_list) {
		...
		for(int idx1 = 0; idx1 < parents_only_element_list.size()-1; idx1++){
			com.crawlerApi.models.Element element1 = parents_only_element_list.get(idx1);
			...
			for(int idx2 = idx1+1; idx2 < parents_only_element_list.size(); idx2++){
				com.crawlerApi.models.Element element2 = parents_only_element_list.get(idx2);
	...
	public List<com.crawlerApi.models.Element> extractElements(String page_src, URL url, List<RuleSet> rule_sets) throws IOException, XPathExpressionException {
	 ...
	 * @throws XPathExpressionException 
	 */
	private synchronized List<com.crawlerApi.models.Element> getDomElements(String page_source, URL url, List<RuleSet> rule_sets) throws IOException, XPathExpressionException {
		assert page_source != null;
		assert !page_source.isEmpty();
		assert url != null;
		assert rule_sets != null;
		
		List<com.crawlerApi.models.Element> visited_elements = new ArrayList<>();
		Map<String, String> frontier = new HashMap<>();
		Map<String, Integer> xpath_cnt = new HashMap<>();
		...
		com.crawlerApi.models.Element root_element = buildElement("//body", attributes, root, ElementClassification.ANCESTOR, css_props );
		...
		while(!frontier.isEmpty()) {
			...
			com.crawlerApi.models.Element element_state = buildElement(next_xpath, attributes, element, classification, pre_render_css_props);
