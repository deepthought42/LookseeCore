...
/**
 * Responsible for executing an audit on the paragraphing and sentence structure on a page
 * 
 * Level: AAA
 */
@Component
public class ParagraphingAudit implements IExecutablePageStateAudit {
	 ...
	 * {@inheritDoc}
	 * 
	 * Scores paragraphs on a page based on if the paragraph has more than 25 words.
	 * 
	 */
	@Override
